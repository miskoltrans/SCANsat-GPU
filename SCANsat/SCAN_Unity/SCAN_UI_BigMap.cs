...
namespace SCANsat.SCAN_Unity
{
	public class SCAN_UI_BigMap : ISCAN_BigMap
	{
		...
		private void SetGridLines()
		{
			...
			// Same dotted graticule on the same UI layer as before, generated by the map shader in the
			// current projection and read back once (was the CPU GenerateGridMap).
			gridMap = bigmap.renderGrid(gridMap);
