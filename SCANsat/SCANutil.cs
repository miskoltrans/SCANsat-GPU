	...
	public static class SCANUtil
	{
		...
		public static SCANterrainConfig generateTerrainConfig(CelestialBody b)
		{
			...
			if (authoredTerrainRange(b, ref newMin, ref newMax))
			{
				...
				authored.SetGenerated(false);   // measured and declared, never overridden by a guess
			...
			config.SetGenerated(true);   // guessed from PQS, not authored in a cfg and not set by the user
